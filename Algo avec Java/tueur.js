...
const characteristics = [
    ...
    new Characteristic("Sportive", 0.2, 0.5, 0.1),
    new Characteristic("Blond", 0.2, 0.4, 0.1),
...
let names = ["Hambre","Elloise","Leho","Trystan","Yauhanne","Cohralie","Mattilde","Taumah","Harolde","Nicaulas"]
...
function attackingSurvivor(survivor) {
    ...
    if (characteristic.probDeath > prob) {
        ...
        console.log(
            survivor.nom +
                " esquive et inflige 10 points de degats a " +
                killer.nom
        );
        killer.pv -= 10;
        console.log(
            "Il ne reste plus que " + killer.pv + " PV a " + killer.nom + "."
        );
        return false;
        ...
        console.log(
            survivor.nom +
                " se fait tuer par " +
                killer.nom +
                " mais lui inflige 15 points de degats avant de mourir."
        );
        killer.pv -= 15;
        console.log(
            "Il ne reste plus que " + killer.pv + " PV a " + killer.nom + "."
...
while (killer.pv > 0 && survivors.length > 0) {
    ...
    if (killer.pv <= 0) {
        console.log(killer.nom + " est mort. Les survivants ont gagne !");
        console.log("RIP a : " + deadSurvivors.join(", "));
        break;
    }
...
if (killer.pv > 0) {
    console.log("Elisa a elimine les survivants. Game over!");
}
